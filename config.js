...
export const listaMeses = ["JANEIRO", "FEVEREIRO", "MARÇO", "ABRIL", "MAIO", "JUNHO", "JULHO", "AGOSTO", "SETEMBRO", "OUTUBRO", "NOVEMBRO", "DEZEMBRO"];

export const filiais = ["MATRIZ", "ARAGUAINA", "GOIANIRA", "BOM DESPACHO", "TOLEDO", "PINHAIS", "NOVA PONTE"];